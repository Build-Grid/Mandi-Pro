...
export const sampleReviews = [
    {
        id: 1,
        name: "Amit",
        text: "Buy and sell entries are now visible in one place, and my daily margin checks are much faster.",
        stars: 4.5,
        createdAt: "",
    },
    {
        id: 2,
        name: "Meera",
        text: "Tracking party ledgers and mandi expenses like labor and transport is now simple and accurate.",
        stars: 5,
        createdAt: "",
    },
    {
        id: 3,
        name: "Ravi",
        text: "We moved from notebooks to digital records and can now monitor claims and damages without confusion.",
        stars: 4.5,
        createdAt: "",
    },
    {
        id: 4,
        name: "Kirtan",
        text: "Profit and loss per trade is instant, which helps us make better pricing decisions throughout the day.",
        stars: 4.5,
        createdAt: "",
    },
    {
        id: 5,
        name: "Mukesh",
        text: "My team can track tola, bora, and other costs without missing entries in manual books.",
        stars: 4.5,
        createdAt: "",
    },
    {
        id: 6,
        name: "Mansaram",
        text: "Mandi-Pro gives us clean visibility across trades, finances, and outstanding party balances.",
        stars: 4.5,
        createdAt: "",
    },
